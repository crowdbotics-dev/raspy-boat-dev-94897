"""
Django settings for raspy_boat_dev_94897 project.
...
ROOT_URLCONF = 'raspy_boat_dev_94897.urls'
...
WSGI_APPLICATION = 'raspy_boat_dev_94897.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_boat_dev_94897 API",
    "DESCRIPTION": "API documentation for raspy_boat_dev_94897 App",
    "VERSION": "v1",
}
